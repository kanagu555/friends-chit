-- Monthly Participants Migration
-- Run this in your Supabase SQL Editor to enable month-specific participants
...
-- Success message
SELECT 'Monthly participants system migration completed successfully!' as message;